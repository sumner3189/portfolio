...
const projectsData: Project[] = [
    ...
    images: [
      {
        ...
        height: 4000,
        likes: 42,
        src: "https://book2-aj8y.onrender.com/",
      },
      // {
  ...
  ProjectConstructor({
    ...
    images: [
      {
        alt: "next.js 13 Weather Application",
        height: 3401,
        likes: 46,
        src: "https://whimsical-marshmallow-96c760.netlify.app/",
        width: 3401,
      },
      // {
      //   alt: '',
